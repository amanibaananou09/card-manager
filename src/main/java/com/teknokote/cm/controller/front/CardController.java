...
public class CardController {
    ...
    public List<CardDto> listCardByFilter(@PathVariable Long customerId,
        ...
        if (expirationDate != null) {
            ...
            parsedDate = YearMonth.parse(expirationDate, formatter).atDay(1);
        }

        return cardService.findCardByFilter(customerId, holder, cardId, parsedDate, actif);
    }
}
